  ...
  const notices = [
    {
      ...
      category: "meeting",
      content:
        "Annual parent-teacher conferences scheduled for February 15-16. Please book your slots online.",
      priority: "high",
    },
    {
      id: 2,
      ...
      category: "event",
      content:
        "Registration open for the annual science fair. Deadline: February 20th.",
      priority: "medium",
    },
    {
      id: 3,
      ...
      category: "holiday",
      content:
        "School will be closed from December 20th to January 5th for winter break.",
      priority: "low",
    },
    {
      id: 4,
      ...
      category: "facility",
      content:
        "Library will now be open until 6 PM on weekdays and 4 PM on Saturdays.",
      priority: "medium",
    },
    {
      id: 5,
      ...
      category: "sports",
      content:
        "Basketball and soccer team tryouts begin next week. See coach for details.",
      priority: "medium",
    },
  ];
